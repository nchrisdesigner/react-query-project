...
function CreateCabinForm({cabinToEdit = {}}) {
  ...
  //Edit or Add -> Boolean(editId) if there is an editIt true, else false
  ...
  function onFormSubmit(data){
    ...
    if(isEditSession){
      editCabin({newCabinData: {...data, img}, id: editId})
    }
    else{
    ...
    <Form onSubmit={handleSubmit(onFormSubmit, onError)}>
      ...
      <FormRow>
        ...
        <FileInput id="image" type="file" accept="image/*" {...register("image", {
          required: isEditSession ? false : "Ths field is required"
        })} />
      </FormRow>
